...
describe('schema-validator', () => {
    describe('validatePayload', () => {
        it('should return null when no validation errors are found', async () => {
            ...
            // Act
            const result = await (0, schema_validator_1.validatePayload)({
                schemaValidator,
                payload,
        ...
        it('should handle validation errors with undefined path', async () => {
            // Arrange
            const mockValidationError = new yup_1.ValidationError('validation error', 'invalid value', 'field');
        ...
        it('should handle validation errors with null message', async () => {
            // Arrange
            const mockValidationError = new yup_1.ValidationError(null, 'invalid value', 'field');
        ...
        it('should handle inner validation errors', async () => {
            // Arrange
            const mockValidationError = new yup_1.ValidationError('outer error', 'invalid value', 'field');
            mockValidationError.path = 'outerField';
            const innerError1 = new yup_1.ValidationError('inner error 1', 'invalid value', 'field');
            innerError1.path = 'innerField1';
            const innerError2 = new yup_1.ValidationError('inner error 2', 'invalid value', 'field');
